      ...
      <div className="wrapper full">
        <div className={styles.productPagearea}>
          ...
          <div className={styles.contentTop}>
            <>
              <div className={styles.info}>
                ...
                <div className={styles.infocontent}>
                  ...
                  {responsive < 900 &&<div className={styles.rightSide}>
                    <article>
                      Məhsul kateqoriyası:
                    </article>
            ...
            {responsive > 900 && <div className={styles.content}>
          ...
          <div className={styles.contentBottom}>
            <div className={styles.personalInfo}>
              ...
              <div className={styles.buttons}>
                {responsive < 900 && <div className={styles.responsiveButton}>
                  <PrimaryButton
                      width='100%'
                      text="Elanı irəli çək.  1 AZN"
                      size="3px 10px"
                ...
                {responsive < 900 &&
                    <PrimaryButton text="Paylaş" size="7px" boxShadow={"none"} onClick={isSupported && handleClick}/>}
              </div>
            </div>
            ...
            <div className={styles.moreDetail}>
              ...
              {responsive > 900 && <PrimaryButton text="Paylaş" size="7px" onClick={isSupported && handleClick}/>}
            </div>
