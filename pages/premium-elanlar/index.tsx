...
const PremiumPage: React.FC<HomePageProps> = () => {
    ...
    async function fetchProducts(param?: boolean) {
        ...
        const response = await api.get('adverts?premium=1&page=' + page + '&search_text=' + (router.query.search_text || '') + '&city=' + (router.query.city || '')
    ...
    return (
        <div>
            ...
            <div className="wrapper">
                ...
                >
                    <div> <ProductsContainer title="Premium elanlar"  list={products} isNotTop={!end} onClick={handleScrollToBottom} /></div>
                </InfiniteScroll>
            </div>
